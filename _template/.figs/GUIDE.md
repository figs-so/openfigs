...
- **Day to day:** `figs report` (a run) · `figs ask` (needs a human) · `figs resolve` (close an ask)
  — they stamp ids/timestamps, capture the session trace, attach artifacts, and push themselves.
