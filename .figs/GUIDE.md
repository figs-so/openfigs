...
- **Day to day:** `figs inbox` (start here — your humans' answers) · `figs report` (a run) · `figs ask` (needs a human) · `figs resolve` (close an ask) — they stamp the bookkeeping and push themselves.
